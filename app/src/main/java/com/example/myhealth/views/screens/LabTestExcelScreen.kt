...
import com.example.myhealth.viewModel.LabTestExcelVM
import com.example.myhealth.views.components.LabTestView

@Composable
fun LabTestExcelScreen(
    onTestDetail:(LabTest)->Unit,
    btnBack:()->Unit
) {
    val viewModel: LabTestExcelVM = hiltViewModel()
    val tests by viewModel.testExcel
...
//@Composable
//fun ShowLabTestExcel() {
//    LabTestExcelScreen(onTestDetail = {})
//}