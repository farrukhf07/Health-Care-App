...
import com.example.myhealth.viewModel.LabTestEssaVm
import com.example.myhealth.views.components.LabTestView

@Composable
fun LabTestEssaScreen(
    onTestDetail:(LabTest)->Unit,
    btnBack:()->Unit
) {
    val viewModel: LabTestEssaVm = hiltViewModel()
    val tests by viewModel.testEssa
...
//@Composable
//fun ShowLabTestEssa() {
//    LabTestEssaScreen(onTestDetail = {})
//}