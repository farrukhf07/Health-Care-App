    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Column (modifier = Modifier
            ...
            Row(
                ...
                Icon(painter = painterResource(id = R.drawable.ic_back), contentDescription = "btn back",
                    tint = white, modifier = Modifier.size(35.dp).clickable { btnBack() })
        ...
        Card(
            ...
            Column(modifier = Modifier
                ...
                Text(text = "High fever\nSevere headache\nPain behind the eyes\nSevere muscle and joint pain\nFatigue and weakness\nNausea and vomiting")
                Spacer(modifier = Modifier.height(20.dp))
                Text(text = "Preventions",
                    fontSize = 20.sp,
                    fontWeight = FontWeight.SemiBold
                )
                Text(text = "Avoid Mosquito Bites\nEliminate Mosquito Breeding Sites\nUse Insecticide-treated Nets and Indoor Sprays\nKeep Doors and Windows Closed or Screened\nWear Protective Clothing")
            }
        }
    }
}
